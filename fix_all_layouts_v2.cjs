...
for (let file of files) {
  ...
  if (htmlBodyMatch) {
    ...
    if (articleMatch) {
      ...
      // strip out old author blocks and sidebars inside <article>
      ...
      // Some layouts had grid structure inside article, but we assume it's mostly content
    } else {
...
console.log("All layouts updated using V2 script.");
