          ...
          <div className="w-full flex flex-col items-start text-left">
            ...
            <div className="w-full opacity-0 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                ...
                <div className="relative flex overflow-hidden [mask-image:linear-gradient(to_right,black_0%,black_90%,transparent)]">
                    ...
                    >
                        {["YONDER", "LES HARDIS", "YOURSUNLIFE", "TALIS EDUCATION GROUP", "SKILINK", "BERNARD MAGREZ", "HÔTEL NOLINSKI", "LAZULI TRAVEL BUREAU", "LAZULI NIL", "YOUNIGHT HOSPITALITY", "BOMPORTO HOTELS", "YONDER", "LES HARDIS", "YOURSUNLIFE", "TALIS EDUCATION GROUP", "SKILINK", "BERNARD MAGREZ", "HÔTEL NOLINSKI", "LAZULI TRAVEL BUREAU", "LAZULI NIL", "YOUNIGHT HOSPITALITY", "BOMPORTO HOTELS", "YONDER", "LES HARDIS", "YOURSUNLIFE", "TALIS EDUCATION GROUP", "SKILINK", "BERNARD MAGREZ", "HÔTEL NOLINSKI", "LAZULI TRAVEL BUREAU", "LAZULI NIL", "YOUNIGHT HOSPITALITY", "BOMPORTO HOTELS"].map((client, i) => (
