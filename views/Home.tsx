...
export const Home: React.FC<{ onNavigate: (p: any) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-x-hidden">
      ...
      {/* --- MARQUEE SECTION --- */}
      <div className="bg-slate-900 py-4 transform -rotate-1 relative z-20 border-y-4 border-white overflow-hidden shadow-2xl shadow-slate-900/10">
      ...
      {/* Footer Strip */}
      <div className="bg-slate-900 text-white py-4 text-center border-t border-slate-800 relative z-20">
