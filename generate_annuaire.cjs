      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        ...
        <section className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 h-full hover:border-blue-300 hover:shadow-md transition-all duration-300">
            ...
            <ul className="space-y-4 mb-6">
              {[
                { title: "Angers : top 5 en 2026", id: "blog" /* route: /blog/agence-seo-angers */ },
                { title: "Avignon : top 5 en 2026", id: "blog" },
                { title: "Bordeaux (À venir)", id: "blog" },
                { title: "La Rochelle : top 5 en 2026", id: "blog" },
                { title: "Lille (À venir)", id: "blog" },
                { title: "Lyon", id: "blog" },
                { title: "Marseille (À venir)", id: "blog" },
                { title: "Toulon : top 5 en 2026", id: "blog" },
                { title: "Vannes : top 5 en 2026", id: "blog" }
              ].map((item, i) => (
            ...
            <ul className="space-y-4">
              <li>
                <a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="font-medium text-blue-700 hover:text-blue-900 flex items-center gap-2 group">
                  <ArrowRight size={14} className="text-blue-400 group-hover:translate-x-1 transition-transform" />
              ...
              <li className="text-slate-500 flex items-center gap-2 pl-6">
                Meilleure agence GEO France (À venir)
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="animate-fade-in-up" style={{ animationDelay: '300ms' }}>
          <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 h-full hover:border-blue-300 hover:shadow-md transition-all duration-300">
            ...
            <ul className="space-y-4">
              {[
                { title: "Comment être cité par ChatGPT en 2026", id: "blog" },
                { title: "Comment ranker sur ChatGPT en 2026 (À venir)", id: "blog" },
                { title: "10 conseils visibilité ChatGPT (À venir)", id: "blog" },
                { title: "Référencement Gemini (À venir)", id: "blog" },
                { title: "Perplexity SEO : comment apparaître (À venir)", id: "blog" },
                { title: "Microsoft Copilot SEO (À venir)", id: "blog" },
                { title: "Grok SEO : être cité (À venir)", id: "blog" },
                { title: "Apparaître sur Google AI Overview", id: "blog" },
                { title: "Agence Google AI Overview : être recommandé", id: "blog" },
                { title: "Google AI Overview et e-commerce", id: "blog" }
              ].map((item, i) => (
                <li key={i}>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-20">
        ...
        <section className="animate-fade-in-up" style={{ animationDelay: '400ms' }}>
          <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 h-full hover:border-blue-300 hover:shadow-md transition-all duration-300">
            ...
            <ul className="space-y-3">
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> Qu'est-ce que le GEO (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> GSO Définition 2026 (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> GSO 2026 Guide Complet (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> SEO vs GSO vs AEO (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> Audit GEO : qu'est-ce que c'est (À venir)</a></li>
            </ul>
            ...
            <ul className="space-y-3">
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> Backlinks SEO Guide Complet (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> E-E-A-T SEO Guide Complet (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> Audit SEO Guide Complet (À venir)</a></li>
            </ul>
          </div>
        </section>
        ...
        <section className="animate-fade-in-up flex flex-col gap-8" style={{ animationDelay: '500ms' }}>
          ...
          <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all duration-300">
            ...
            <ul className="space-y-3">
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> SEO Local Paris 2026 (À venir)</a></li>
              <li><a href="#" onClick={(e) => handleLinkClick(e, 'blog')} className="text-blue-700 hover:text-blue-900 flex items-center gap-2 group"><ArrowRight size={14} className="text-blue-400" /> Audit SEO Paris 2026 (À venir)</a></li>
            </ul>
          </div>
